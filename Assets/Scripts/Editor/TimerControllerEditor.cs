...
[CanEditMultipleObjects, CustomEditor(typeof(TimerController))]
public class TimerControllerEditor : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        if (showDisplayInfo)
        {
            ...
            TimerController.OutputType tt = (TimerController.OutputType)textType_Prop.enumValueIndex;

            switch (tt)
            {
                case TimerController.OutputType.StandardText:

                    EditorGUILayout.ObjectField(standardText_Prop);
                    break;

                case TimerController.OutputType.TMPro:

                    EditorGUILayout.ObjectField(textMeshPro_Prop);
                    break;

                case TimerController.OutputType.HorizontalSlider:
                ...
                case TimerController.OutputType.Dial:
